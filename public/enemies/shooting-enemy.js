...
export default class ShooterEnemy extends Enemy {
    ...
    createBullet(entity, targetEntity) {
        ...
        let bullet = new Bullet(entity.game, centerX - 7, centerY - 7, 1, 2, grainAngle, grainVectorX, grainVectorY, 0, entity.damage, false, entity.gunKnockbackMultiplier, "blue", this.game.assetLoader.bullets.enemybullet)
